package com.example.kepler.maptest.map.view.recyclerview;
...
public class SiteAdapter extends RecyclerView.Adapter<SiteAdapter.SiteViewHolder>{
    ...
    public SiteAdapter(MapPresenter mPresenter, List<Item> list) {
        ...
        public SiteViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mPresenter.onSiteClicked(getAdapterPosition());
                }
            });
            btn_add.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mPresenter.onSiteAddClicked(getAdapterPosition());
                }
            });
        }
    }
